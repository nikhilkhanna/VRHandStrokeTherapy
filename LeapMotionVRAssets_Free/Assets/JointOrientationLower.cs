...
public class JointOrientationLower : MonoBehaviour
{
	...
	//***inserted stuff here
	public static Vector3 elbow;
	public static float lengthUpper;
	//***this is new
	void Start()
	{
		elbow = new Vector3 (0.0f, 0.0f, 0.0f);
		controller = new Controller();
		lengthUpper = 0.0f;//if these initializations don't work we can change them later
	}
